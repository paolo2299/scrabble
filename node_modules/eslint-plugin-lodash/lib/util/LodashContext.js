...
var getSettings = _require.getSettings;
    ...
    _createClass(_class, [{
        ...
        get: function get() {
            if (!this._version) {
                ...
                var pragma = _getSettings.pragma;
                var version = _getSettings.version;
        ...
        get: function get() {
            if (!this._pragma) {
                ...
                var pragma = _getSettings2.pragma;
                var version = _getSettings2.version;
